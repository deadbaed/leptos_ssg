  ...
  internal = rec {
    ...
    crates = {
      ...
      "example" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./example; };
        dependencies = [
          {
            name = "leptos";
            packageId = "leptos";
        ...
        features = {
          "opengraph" = [ "leptos_ssg/opengraph" ];
          "optimize" = [ "leptos_ssg/optimize" ];
        };
      ...
      "opengraph" = rec {
        ...
        version = "0.1.0";
        edition = "2024";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./opengraph; };
        dependencies = [
          {
            name = "fantoccini";
